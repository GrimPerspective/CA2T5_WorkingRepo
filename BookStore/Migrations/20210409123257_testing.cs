    ...
    public partial class testing : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Brings powerful charting capabilities to your .NET applications.", "1.png", ".NET Charts", 99.0 },
                    { 2, "Integrate your .NET apps with PayPal the easy way!", "1.png", ".NET PayPal", 69.0 },
                    { 3, "Supercharged .NET machine learning libraries.", "1.png", ".NET ML", 299.0 },
